...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate a project status summary Markdown file."
    )
    parser.add_argument("project_root", type=Path, help="Root directory of the target project")
    parser.add_argument("--output", type=Path, default=None, help="Output file path (default: <project_root>/project_summary.md)")
